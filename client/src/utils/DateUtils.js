...
// Sort the array based on the custom month order -> to be used in the "view all" section of the award page
export const sortDataInFinancialMonthOrder = (data) => {
  // Mapping from month names to their indices
  const monthOrder = {};
  monthsInFinancialOrder.forEach((month, index) => {
